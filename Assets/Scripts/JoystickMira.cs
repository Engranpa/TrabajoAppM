...
namespace UnityStandardAssets.CrossPlatformInput
{
	public class JoystickMira : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IDragHandler
	{
		...
		public string horizontalAxisName = "HorizontalM"; // The name given to the horizontal axis for the cross platform input
		...
		void CreateVirtualAxes()
		{
			...
			if (m_UseX)
			{
				m_HorizontalMVirtualAxis = new CrossPlatformInputManager.VirtualAxis(horizontalAxisName);
